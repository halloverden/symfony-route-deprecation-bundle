...
- `enforce` is a boolean value that defines if the route is inaccessible after the `until` date. In this case a `GoneHttpException` is thrown with HTTP Status 410 Gone.
